export default function MissionSection() {
  return (
    <section className="w-full px-4 py-16 backdrop-blur-md bg-gradient-to-r from-green-900/20 via-red-900/20 to-green-900/20 christmas-theme" id="mission-statement">
      <div className="flex items-center flex-col justify-center max-w-6xl md:flex-row-reverse md:space-x-8 md:space-x-reverse mx-auto">
        <div className="flex items-center animate-on-scroll justify-center md:w-1/2 mb-8 md:mb-0 slide-right">
          <div className="relative">
            <img
              ...
              src="https://placehold.co/600x400/1a1a1a/ffffff?text=🎄+Innovation,+Teamwork,+Empowerment.+❄️"
            />
        ...
        <div className="animate-on-scroll md:w-1/2 md:text-left text-center slide-left">
          <h2 className="font-extrabold text-4xl mb-8 md:text-5xl">
            Our <span className="gradient-text-christmas">Mission</span> 🎄
          </h2>
          <p className="text-lg leading-relaxed text-white/90">
            ...
            that values our team, while empowering businesses to thrive and achieve their goals. Together, we're building
            the future with cutting-edge hosting solutions and exceptional service that brings communities together.
          </p>
        </div>
      </div>
    </section>
