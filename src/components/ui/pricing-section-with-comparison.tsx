...
function Pricing() {
  ...
  return (
    <section className="w-full px-4 py-16 backdrop-blur-md bg-gradient-to-r from-green-900/20 via-red-900/20 to-green-900/20 christmas-theme">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="font-extrabold text-4xl mb-8 md:text-5xl">
          Our <span className="gradient-text-christmas">Pricing</span> Plans 🎄
        </h2>
